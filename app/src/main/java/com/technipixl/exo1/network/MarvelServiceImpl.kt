...
class MarvelServiceImpl {
    ...
    //suspend fun getCharacterDetail(): Response<MarvelDetailResponse> = getRetrofit().create(MarvelServices::class.java).characterDetailList(id, publicKey, timeStamp.toString(), hashExample.toString())
}